...
Through its integration with ASE, PyDMF can access a broad range of electronic-structure and force-field engines for transition-state searches. Well-established packages such as VASP [@Kresse1993VASP; @Kresse1994VASP; @Kresse1996VASPCMS; @Kresse1996VASPPRB], Quantum ESPRESSO [@Giannozzi2009QE; @Giannozzi2017QE], CP2K [@Kuhne2020CP2K], ORCA [@Neese2012ORCA], Gaussian [@Gaussian16], GAMESS [@Barca2020GAMESS], LAMMPS [@Thompson2022LAMMPS], Amber [@Case2025Amber], and GROMACS [@Abraham2015GROMACS] can be used as backends without any modification to PyDMF. This design choice preserves backend flexibility while allowing PyDMF to integrate smoothly into diverse atomistic modeling workflows. Usage examples and API documentation are available in the project’s GitHub repository [@pydmf].
