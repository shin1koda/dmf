...
class FB_ENM(Calculator):
    ...
    def calculate(self, atoms, properties, system_changes):
        ...
        del d_rep, d_att; torch.cuda.empty_cache()
        i = self._iu
        j = self._ju
        rij = pos[i]-pos[j]
        ...
        if self._return_energy_mats:
            ...
            del e_rep, e_att; torch.cuda.empty_cache()
        del pos, inv_dmin2, inv_dmax2, f1, i, j, rij, dij, uij, coeff, contrib, forces; torch.cuda.empty_cache()
